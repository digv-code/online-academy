        ...
        <div className='text-richblack-5 w-[100vw]'>
            <section className='lg:w-[100%] bg-richblack-800 flex justify-center items-center'>
                ...
                <div className='relative w-11/12 mx-auto flex flex-col items-center justify-center my-36'>
                    <h1 className='text-3xl lg:w-[55%] text-center font-inter font-semibold'>Driving Innovation in Online Education for
                        <HighlightText text={"Brighter Future"} />
                    </h1>

                    <div className='lg:w-[60%] my-6 text-base font-inter font-[500] text-center'>
                        Online Academy is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering a platform for EDUCATIONAL COLLABORATION 
                    </div>
